...
CREATE TABLE `trips` (
  ...
  `transporter_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `pickup_location` varchar(255) NOT NULL,
  `product_type` varchar(100) NOT NULL,
  `product_weight` decimal(10, 2) NOT NULL,
  `product_bill_image` varchar(255) DEFAULT NULL,
  `pickup_product_location_image` varchar(255) DEFAULT NULL,
  `pickup_remarks` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `drop_remarks` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
